...
<head>
    ...
    <title>filapanel.com - ATM_portal</title>
</head>
...
<section class="min-h-screen bg-gradient-to-b from-orange-600 via-orange-500 to-orange-400 flex items-center md:overflow-hidden">
    <div class="mx-auto md:flex md:items-center md:justify-between">
        <div class="w-full md:w-1/2 ml-2.5 md:ml-20 mb-10 md:mb-0">
            ...
            <div class="space-x-2">
                <a href="/employee" class="bg-white px-4 py-2 rounded shadow-lg">Login to panel employee</a><a href="/user" class="bg-white px-4 py-2 rounded shadow-lg">Login to panel user</a><a href="/admin" class="bg-white px-4 py-2 rounded shadow-lg">Login to panel admin</a>
            </div>
        </div>
